										...
										<ul class="bxslider">
											<li>
												<div id="slide01" class="slide">
													<img class="center" src="{vimage_path('android_text.png')}">
												</div>
											</li>
											<li>
												<div id="slide02" class="slide">
													<img class="center" src="{vimage_path('iphone.png')}"/>
												</div>
											</li>
											<li>
												<div id="slide03" class="slide">
													<img class="center" src="{vimage_path('ipad.png')}"/>
												</div>
											</li>
											<li>
												<div id="slide04" class="slide">
													<img class="center" src="{vimage_path('exchange_conn_text.png')}"/>
												</div>
											</li>
											<li>
												<div id="slide05" class="slide">
													<img class="center" src="{vimage_path('outlook_text.png')}"/>
												</div>
											</li>
										</ul>
									</div>
